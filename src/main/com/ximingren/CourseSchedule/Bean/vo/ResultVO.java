...
public class ResultVO {
    ...
    private Object data;
    private Map<String,Integer> pageData;
    ...
    public Map<String, Integer> getPageData() {
        return pageData;
    }

    public void setPageData(Map<String, Integer> pageData) {
    ...
    public static ResultVO ok(String message,Object data,Map<String,Integer> pageDate){
        ResultVO resultVO = new ResultVO();
        resultVO.setMessage(message);
        resultVO.setCode(SUCCESS_CODE);
        resultVO.setData(data);
